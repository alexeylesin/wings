...
debug:
	go build -ldflags="-X github.com/alexeylesin/wings/system.Version=$(GIT_HEAD)" -race
...
rmdebug:
	go build -gcflags "all=-N -l" -ldflags="-X github.com/alexeylesin/wings/system.Version=$(GIT_HEAD)" -race
